...
const ViewSubmitWork = ({ assignmentId }: ViewSubmitWorkProps) => {
  const { data: viewSubmitWork } = trpc.getViewSubmitWork.useQuery({
    id: assignmentId!,
  });
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-screen-xl">
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              <TableCell>{viewSubmitWork?.moduleObjectId?.name}</TableCell>
              <TableCell>{viewSubmitWork?.assignmentObjectId?.title}</TableCell>
              <TableCell>
